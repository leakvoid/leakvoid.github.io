...
const translations = {
    ...
    "about-gamedev": "For a long time I wanted to pursue game development, and some time ago I made a decision to change direction of my career. I've been learning about <strong>Unity</strong> engine, <strong>C#</strong>, <strong>DOTS (ECS)</strong>, <strong>Netcode (NGO, NfE)</strong>, <strong>Shaders (HLSL)</strong>, various aspects of game development and recently finished large demonstration project for my portfolio.",
